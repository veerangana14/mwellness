        ...
        >
            <div className="flex flex-col items-center justify-center min-h-screen 2xsm-md:w-10/12 2xsm-md:m-auto ">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
                    <h2 className="text-2xl font-bold text-left text-green-700 md:text-3xl">Register</h2>
                    <h5 className="text-sm font-normal text-left mb-6 text-green-700">Enter your email and password to sign-up</h5>
                    <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                            <label htmlFor="name" className="block text-left text-md font-medium text-gray-700 mb-1 2xsm-md:text-sm">
                                Name
                            </label>
                            <input
                                type="text"
                        ...
                        <span className="text-green-700 2xsm-md:text-sm">Already have an account ? &nbsp;
                            <span className="text-green-700" onClick={() => navigate("/dashboard/login")}>
                                Sign in
                            </span>
                        </span>
                    </form>
